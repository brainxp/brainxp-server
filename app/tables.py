...
policies = Table(
    ...
    Column("initial_grant_seconds", Integer, nullable=False, server_default="1800"),
    Column("daily_cap_seconds", Integer, nullable=False, server_default="3600"),
    Column("balance_ceiling_seconds", Integer, nullable=False, server_default="10800"),
...
quiz_sessions = Table(
    ...
    Column("overflow_points", Integer),
